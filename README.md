...
|---	|---	|---	|---	|
|[Анализ оттока клиентов банка]() | Банки | В распоряжении данные о клиентах банка за месяц. Банк располагается в Ярославле и областных городах: Ростов Великий и Рыбинск. Клиенты стали уходить, необходимо провести анализ и разобраться в причинах оттока. Дать рекомендации, как снизить отток клиенов.| `Python`, `Pandas`, `NumPy`, `Matplotlib`, `Plotly` ,`Seaborn`, `Scipy`|
